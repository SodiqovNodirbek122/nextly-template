...
function ContactForm() {
  ...
  const handleSubmit = (event) => {
    ...
    // fetch("https://relief-bot.onrender.com/submit-form", {
    //   method: "POST",
    //   headers: {
  ...
  return (
    <>
      <div className="my-10">
        <div className="max-w-screen-xl mt-24 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-voltiva-100 text-gray-900 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit}>
            {loading && (
              <div
                ...
                role="alert"
              >
                <p className="font-bold">Спасибо за ваш запрос!</p>
              </div>
            )}
            <div>
